        ...
        <div class="about-wrapper">
            <div class="row align-items-center justify-content-between">
                <div class="col-xl-6 col-lg-7 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="about-content">
                        <div class="section-title">
                            ...
                            <p>GoFly Travel Agency is a trusted name in the travel industry, offering seamless
                                travel planning, personalized itineraries, and unforgettable adventures. With years
                                of experience and a network of global partners, we ensure a hassle-free and
                                memorable journey for every traveler.</p>
                        ...
                        <div class="founder-area"><img alt="" loading="lazy" width="100" height="220" decoding="async"
                                data-nimg="1" style="color:transparent"
                                src="../_next/image/url%3D%252Fassets%252Fimg%252Finnerpages%252Fabout-page-founder-signature.png%26w%3D256%26q%3D75">
                            <div class="founder-info">
                                <h6>Robert Harringson</h6><span>Founder at GoFly</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5 d-lg-block d-none wow animate fadeInRight" data-wow-delay="200ms"
                    ...
                    <div class="about-img"><img alt="" loading="lazy" width="550" height="220" decoding="async"
                            data-nimg="1" style="color:transparent"
                            src="../_next/image/url%3D%252Fassets%252Fimg%252Fhome3%252Fabout-img.png%26w%3D1200%26q%3D75">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="service-wrapper">
            <div class="row justify-content-center wow animate fadeInDown" data-wow-delay="200ms"
                ...
                <div class="col-lg-9">
                    <div class="section-title">
                        <h2>We’re Providing Best Service Ever!</h2><svg height="6" viewBox="0 0 872 6"
            ...
            <ul class="service-list wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                ...
                <li class="single-service">
                    ...
                    <div class="content">
                        <h4>Saves Money</h4>
                        <p>Avoids hidden fees &amp; tourist traps, Multi-destination &amp; budget-friendly options.
                        </p>
                    </div>
                </li>
            </ul>
            <div class="bottom-area d-flex justify-content-center wow animate fadeInUp" data-wow-delay="200ms"
                data-wow-duration="1500ms">
                <div class="batch"><span>Flat 30% Discounts All Packages</span><a href="../travel-package/">Check
                        Offer<svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="container">
        <div class="row justify-content-center mb-50 wow animate fadeInDown" data-wow-delay="200ms"
            ...
            <div class="col-lg-8">
                <div class="section-title text-center">
                    ...
                    <p>With years of experience in the travel industry, we specialize in crafting personalized
                        journeys.</p>
                </div>
            </div>
        </div>
        <div class="jouney-content-wrapper">
            <div class="nav-area mb-50">
                            ...
                            <div class="swiper-slide">
                                <div class="nav-item" role="presentation">
                                    <div class="nav-link active" id="pills-one-tab" data-bs-toggle="pill"
                                        ...
                                        aria-selected="true"><img alt="" loading="lazy" width="195" height="195"
                                            decoding="async" data-nimg="1" style="color:transparent"
                                            src="../_next/image/url%3D%252Fassets%252Fimg%252Finnerpages%252Fabout-page-journey-img1.jpg%26w%3D640%26q%3D75">
                                        <h4>1986</h4>
                            ...
                            <div class="swiper-slide">
                                <div class="nav-item" role="presentation">
                                    <div class="nav-link" id="pills-two-tab" data-bs-toggle="pill"
                                        ...
                                        aria-selected="true"><img alt="" loading="lazy" width="195" height="195"
                                            decoding="async" data-nimg="1" style="color:transparent"
                                            src="../_next/image/url%3D%252Fassets%252Fimg%252Finnerpages%252Fabout-page-journey-img2.jpg%26w%3D640%26q%3D75">
                                        <h4>1996</h4>
                                    </div><span class="dot"></span>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="nav-item" role="presentation">
                                    <div class="nav-link" id="pills-three-tab" data-bs-toggle="pill"
                                        ...
                                        aria-selected="true"><img alt="" loading="lazy" width="195" height="195"
                                            decoding="async" data-nimg="1" style="color:transparent"
                                            src="../_next/image/url%3D%252Fassets%252Fimg%252Finnerpages%252Fabout-page-journey-img3.jpg%26w%3D640%26q%3D75">
                                        <h4>2006</h4>
                                    </div><span class="dot"></span>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="nav-item" role="presentation">
                                    <div class="nav-link" id="pills-four-tab" data-bs-toggle="pill"
                                        ...
                                        aria-selected="true"><img alt="" loading="lazy" width="195" height="195"
                                            decoding="async" data-nimg="1" style="color:transparent"
                                            src="../_next/image/url%3D%252Fassets%252Fimg%252Finnerpages%252Fabout-page-journey-img4.jpg%26w%3D640%26q%3D75">
                                        <h4>2016</h4>
                                    </div><span class="dot"></span>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="nav-item" role="presentation">
                                    <div class="nav-link" id="pills-five-tab" data-bs-toggle="pill"
                                        ...
                                        aria-selected="true"><img alt="" loading="lazy" width="195" height="195"
                                            decoding="async" data-nimg="1" style="color:transparent"
                                            src="../_next/image/url%3D%252Fassets%252Fimg%252Finnerpages%252Fabout-page-journey-img5.jpg%26w%3D640%26q%3D75">
                                        <h4>2022</h4>
                                    </div><span class="dot"></span>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="nav-item" role="presentation">
                                    <div class="nav-link" id="pills-six-tab" data-bs-toggle="pill"
                                        ...
                                        aria-selected="true"><img alt="" loading="lazy" width="195" height="195"
                                            decoding="async" data-nimg="1" style="color:transparent"
                                            src="../_next/image/url%3D%252Fassets%252Fimg%252Finnerpages%252Fabout-page-journey-img6.jpg%26w%3D640%26q%3D75">
                                        <h4>2023</h4>
                                    </div><span class="dot"></span>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="nav-item" role="presentation">
                                    <div class="nav-link" id="pills-seven-tab" data-bs-toggle="pill"
                                        ...
                                        aria-selected="true"><img alt="" loading="lazy" width="195" height="195"
                                            decoding="async" data-nimg="1" style="color:transparent"
                                            src="../_next/image/url%3D%252Fassets%252Fimg%252Finnerpages%252Fabout-page-journey-img7.jpg%26w%3D640%26q%3D75">
                                        <h4>2025</h4>
                                    </div><span class="dot"></span>
                                </div>
                            </div>
                ...
                </div><svg class="line" height="6" viewBox="0 0 1320 6" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <div class="col-xl-8 col-lg-10">
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-one" role="tabpanel"
                            ...
                            <p>The first-ever travel agency was founded by <span>Thomas Cook</span> in England. He
                                organized group trips, starting with a railway excursion for <span>500 people
                                </span>. Thomas Cook expanded his services internationally, arranging trips to Paris
                                and beyond. He introduced the <span>first-ever travel brochure, guiding travelers on
                                    destinations &amp; routes.</span> Luxury cruises and organized tours gained
                                popularity, especially among the elite.</p>
                        </div>
...
<div class="about-video-section mb-100">
    <div class="container">
        <div class="lg-react-element video-wrap"><img alt="" loading="lazy" width="1300" height="220" decoding="async"
                data-nimg="1" style="color:transparent"
                src="../_next/image/url%3D%252Fassets%252Fimg%252Finnerpages%252Fabout-video-img.jpg%26w%3D3840%26q%3D75"><a
                data-fancybox="video-player" class="gallery-item play-btn"
                data-src="https://www.youtube.com/watch?v=u31qwQUeGuM&amp;t=1s" style="cursor:pointer"><i
