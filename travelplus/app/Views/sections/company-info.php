        ...
        <div class="row g-xl-4 g-lg-3 g-4 mb-100">
            <div class="col-lg-4 col-md-6 d-flex">
                <div class="single-contact">
                    <div class="icon"><svg width="36" height="36" viewBox="0 0 36 36"
                    ...
                    <h6><span>Hotline :</span> <a href="#">(+84) 79 568 1 568</a></h6>
                    <p>47 đường Lê Văn Hưu, Phường Hai Bà Trưng, TP Hà Nội</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 d-flex">
                <div class="single-contact two">
                    ...
                    <h4>Văn phòng HCM</h4>
                    <h6><span>Hotline :</span> <a href="#">(+84) 79 568 1 568</a></h6>
                    <p>3/30A đường Thích Quảng Đức, Phường Đức Nhuận, TP HCM</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 d-flex">
                <div class="single-contact three">
                    ...
                    <h6><span>Hotline :</span> <a href="#">(+84) 79 568 1 568</a></h6>
                    <p>Tầng 4 Tòa nhà Trực thăng Miền Trung, đường Nguyễn Văn Linh, Phường Hòa Cường, TP Đà Nẵng</p>
                </div>
            </div>
        </div>
