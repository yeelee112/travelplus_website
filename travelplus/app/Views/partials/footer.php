<footer class="footer-section">
    <div class="container">
        <div class="footer-contact-wrap">
            <div class="inquiry-area"><svg width="36" height="36" viewBox="0 0 36 36"
            ...
            <div class="row gy-md-4 gy-5">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-md-end">
                    <div class="footer-widget">
                        ...
                        <ul class="widget-list">
                            ...
                            <li><a href="/travel-package">Bali, Indonesia Tour</a></li>
                            ...
                            <li><a href="/travel-package">New Zealand Tour </a></li>
                            <li><a href="/travel-package">Costa Rica Tour</a></li>
                            <li><a href="/travel-package">Peru (Machu Picchu)</a></li>
                            <li><a href="/travel-package">Paris, France Tour</a></li>
                            <li><a href="/travel-package">Rome, Italy Tour</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-md-end">
                    <div class="footer-widget">
                        ...
                        <ul class="widget-list">
                            <li><a href="/travel-package/style2">Adventure</a></li>
                            <li><a href="/travel-package/style2">Hiking &amp; Stiking</a></li>
                            <li><a href="/travel-package/style2">Holiday Packages</a></li>
                            <li><a href="/travel-package/style2">Flights And Hotels</a></li>
                            <li><a href="/travel-package/style2">Honeymoon Trip</a></li>
                            <li><a href="/travel-package/style2">Bali Vacation Package</a></li>
                            <li><a href="/travel-package/style2">Desert Safari</a></li>
                            <li><a href="/travel-package/style2">Last-Minute Deals</a></li>
                            <li><a href="/travel-package/style2">Summer Vacation</a></li>
                            <li><a href="/travel-package/style2">Wildlife Safari</a></li>
                            <li><a href="/travel-package/style2"> Dubai Luxury Tours</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 d-flex justify-content-lg-end">
                    <div class="footer-widget">
                        ...
                        <ul class="widget-list">
                            <li><a href="/about">About GoFly</a></li>
                            <li><a href="#">Health &amp; Safety Measure</a></li>
                            <li><a href="/visa">Visa Processing</a></li>
                            <li><a href="/contact">Customize Tour</a></li>
                            <li><a href="/travel-inspiration">Travel Inspirations</a></li>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="copyright-and-payment-method-area">
                ...
                <div class="payment-method-area"><span>Accepted Payment Methods :</span>
                    <ul>
                        <li><img alt="" loading="lazy" width="52" height="28" decoding="async" data-nimg="1"
                                style="color:transparent" src="/assets/img/home1/icon/mastar-card-icon.svg"></li>
                        <li><img alt="" loading="lazy" width="52" height="28" decoding="async" data-nimg="1"
                                style="color:transparent" src="/assets/img/home1/icon/visa-icon.svg"></li>
                        <li><img alt="" loading="lazy" width="52" height="28" decoding="async" data-nimg="1"
                                style="color:transparent" src="/assets/img/home1/icon/paypal-icon.svg"></li>
                        <li><img alt="" loading="lazy" width="52" height="28" decoding="async" data-nimg="1"
                                style="color:transparent" src="/assets/img/home1/icon/gpay-icon.svg"></li>
                    </ul>
                </div>
            </div>
        </div>
