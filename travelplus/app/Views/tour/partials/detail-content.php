                            ...
                            <div class="accordion-header">
                                <div class="accordion-button" role="button" data-bs-toggle="collapse"
                                    ...
                                    <div class="title-area"><span class="check"></span>
                                        <h6>KHÁM PHÁ TÂY ÂU: PHÁP – THỤY SĨ – Ý</h6>
                                    </div><span>103,900,000đ<sub>/người</sub></span>
                                </div>
                            </div>
                            <div class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body">
                                    <div class="tour-info-and-calculate-area">
                                        <p>10 Ngày 9 Đêm | Khởi hành: 15/05/2025</p>
                                    </div>
                                    <div class="additional-service-area" data-max-travelers="15">
                                        <h6>Số lượng người <sub>(Tối đa 15 người)</sub></h6>
                                        <ul class="service-list booking-service-list">
                                            <li class="booking-service-item" data-service-type="adult" data-unit-price="103900000" data-min="1">
                                            ...
                                            <li class="booking-service-item" data-service-type="child" data-unit-price="88315000" data-min="0">
                                                <div class="service-info-wrap">
                                                    <div class="service-info">
                                            ...
                                            <li class="booking-service-item" data-service-type="infant" data-unit-price="25975000" data-min="0">
                                                <div class="service-info-wrap">
                                                    <div class="service-info">
                                        ...
                                        <div class="booking-total-area">
                                            ...
                                            <strong class="booking-grand-total">103.900.000 ₫</strong>
                                        </div>
                                    </div>
                                    <div class="btn-area">
                ...
                <div class="package-details-sidebar">
                    <div class="pricing-and-booking-area mb-40">
                        <div class="price-area">
                            <h6>Giá tour</h6><span> 103,900,000 đ<sub>/người</sub></span> <br><del>125,900,000 đ</del><sub>/người</sub>
                        </div>
                        <ul>
