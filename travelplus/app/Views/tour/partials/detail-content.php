    ...
    <div class="swiper home2-banner-slider">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="banner-bg" style="background-image: url('assets/images/home/banner01.jpg')">
                </div>
            </div>
            <div class="swiper-slide">
                <div class="banner-bg" style="background-image: url('assets/images/home/banner02.jpg')">
                </div>
            </div>
            <div class="swiper-slide">
                <div class="banner-bg" style="background-image: url('assets/images/home/banner01.jpg')">
    ...
    <div class="banner-content-wrap">
        <div class="container">
            <div class="banner-content">
                <h1>KHÁM PHÁ TÂY ÂU: PHÁP – THỤY SĨ – Ý</h1>
                <div class="batch"><span>10 Ngày 9 Đêm | Khởi hành: 30/05/2026</span></div>
            </div>
        </div>
    </div>
    <div class="slider-btn-grp">
        <div class="slider-btn banner-slider-prev"><svg width="22" height="22" viewBox="0 0 22 22"
                xmlns="http://www.w3.org/2000/svg">
                <g>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M0 10.0571H22V11.9428H0V10.0571Z"></path>
        ...
        <div class="slider-btn banner-slider-next"><svg width="22" height="22" viewBox="0 0 22 22"
                xmlns="http://www.w3.org/2000/svg">
                <g>
            ...
            <div class="modal-body">
                ...
                <ul class="star-rating-list">
                    <li><span>Overall</span>
                        <div class="rating-container" data-rating="0"><i class="bi bi-star star-icon"></i><i
                                class="bi bi-star star-icon"></i><i class="bi bi-star star-icon"></i><i
                                class="bi bi-star star-icon"></i><i class="bi bi-star star-icon"></i></div>
                    </li>
                    ...
                    <li><span>Tour Guide</span>
                        <div class="rating-container" data-rating="0"><i class="bi bi-star star-icon"></i><i
                                class="bi bi-star star-icon"></i><i class="bi bi-star star-icon"></i><i
                                class="bi bi-star star-icon"></i><i class="bi bi-star star-icon"></i></div>
                    </li>
                    <li><span>Accomodation</span>
                        <div class="rating-container" data-rating="0"><i class="bi bi-star star-icon"></i><i
                                class="bi bi-star star-icon"></i><i class="bi bi-star star-icon"></i><i
                                class="bi bi-star star-icon"></i><i class="bi bi-star star-icon"></i></div>
                    </li>
                ...
                <form class="review-form-wrapper">
                    <div class="row g-4 mb-50">
                        <div class="col-lg-12">
                            <div class="form-inner"><label>Your Feedback</label><textarea
                                    placeholder="Write a your tour feedback"></textarea></div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-inner"><label>Your Name</label><input type="text" placeholder="Your Name">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-inner2">
                                <div class="form-check"><input class="form-check-input" type="checkbox"
                                        id="contactCheck22"><label class="form-check-label" for="contactCheck22">Save my
                                        email address &amp; name when I comment further
                                        time.</label></div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content"><button type="button" class="close-btn" data-bs-dismiss="modal"
            ...
            <div class="modal-header">
                ...
                <p>Select your travel date &amp; time, also minium traveller for reason easily booking a package.
                </p>
            </div>
            <div class="modal-body">
                <form>
                    <div class="row g-4 mb-50">
                        <div class="col-sm-6">
                            <div class="single-field date-field"><svg width="18" height="18" viewBox="0 0 18 18"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g>
                                        <path
                                ...
                                <div class="custom-select-dropdown"><input type="text" readonly=""
                                        name="tourBookingCalendar" value="Sep 12 - Sep 20">
                                    <div class="selected-date"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="single-field"><svg width="18" height="18" viewBox="0 0 18 18"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                ...
                                <div class="custom-select-dropdown">
                                    <h6><span id="adult-qty">1</span> Adults</h6><span>Select Travelers</span>
                                </div>
                                <div class="custom-select-wrap">
                                    <div class="title-area">
                                        <h6>Travelers</h6><span>You can book for a maximum of 12 people</span>
                                    </div>
                                    <ul class="guest-count">
                                        <li class="single-item">
                                            <div class="title">
                                                <h6>Adult</h6><span>16 years+</span>
                                            </div>
                                            <div class="quantity-counter"><a href="#" data-type="adult"
                                                    class="guest-quantity__minus"><i class="bi bi-dash"></i></a><input
                                                    type="text" class="quantity__input" name="adult_quantity"
                                                    value="1"><a href="#" data-type="adult"
                                                    class="guest-quantity__plus"><i class="bi bi-plus"></i></a></div>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="calendar-inner">
                            <div class="calendar-container">
                                <div class="calendar" id="calendar-prev">
                                    <div class="calendar-header"><button class="prev-month"><svg width="16" height="16"
                                                viewBox="0 0 16 16">
                                                <path d="M10 2L4 8l6 6" stroke="currentColor" fill="none"
                                                    stroke-width="2"></path>
                                            </svg></button>
                                        <h6 id="month-year-prev">August 2025</h6><button class="next-month"><svg
                                    ...
                                    <div class="calendar-dates" id="calendar-dates-prev">Previous month dates will
                                        be populated here</div>
                                </div>
                            </div>
                            <div class="calendar-actions"><a href="#" id="tour-calendar-check"
                                    class="calendar-check underline">Apply</a></div>
                        </div>
                    </div>
                </form>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" id="flush-package-headingOne">
                                <div class="accordion-button" role="button" data-bs-toggle="collapse"
                                    ...
                                    <div class="batch"><span>Group Tour</span></div>
                                ...
                                <div class="accordion-body">
                                    <div class="tour-info-and-calculate-area">
                                        <p>An 11-night journey covering Bangkok <i class="bi bi-arrow-right"></i>
                                            ...
                                            Phuket.</p>
                                        <div class="price-calculate"><span class="adult">$30 <i class="bi bi-x"></i>
                                                2 Adult</span></div>
                                    </div>
                                    <div class="additional-service-area">
                                        ...
                                        <ul class="service-list">
                                            <li>
                                                <div class="service-info-wrap"><label class="containerss"><input
                                                    ...
                                                    <div class="service-info">
                                                        ...
                                                        <p>Offer professional photo packages or digital keepsakes of
                                                            key moments on the tour.</p>
                                                    </div>
                                                </div>
                                                <div class="pricing-and-count-area"><span>$49.00</span>
                                                    <div class="quantity-counter"><a href="#" data-type="adult"
                                                            class="quantity__minus"><i class="bi bi-dash"></i></a><input
                                                            type="text" class="quantity__input" name="quantity"
                                                            value="1"><a href="#" data-type="adult"
                                                            class="quantity__plus"><i class="bi bi-plus"></i></a></div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="service-info-wrap"><label class="containerss"><input
                                                ...
                                                <div class="pricing-and-count-area"><span>$30.00</span>
                                                    <div class="quantity-counter"><a href="#" data-type="adult"
                                                            class="quantity__minus"><i class="bi bi-dash"></i></a><input
                                                            type="text" class="quantity__input" name="quantity"
                                                            value="1"><a href="#" data-type="adult"
                                    ...
                                    <div class="btn-area"><a class="primary-btn1 two" href="../../checkout/"><span>Book
                                                Now<svg width="10" height="10" viewBox="0 0 10 10"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M9.73535 1.14746C9.57033 1.97255 9.32924 3.26406 9.24902 4.66797C9.16817 6.08312 9.25559 7.5453 9.70214 8.73633C9.84754 9.12406 9.65129 9.55659 9.26367 9.70215C8.9001 9.83849 8.4969 9.67455 8.32812 9.33398L8.29785 9.26367L8.19921 8.98438C7.73487 7.5758 7.67054 5.98959 7.75097 4.58203C7.77875 4.09598 7.82525 3.62422 7.87988 3.17969L1.53027 9.53027C1.23738 9.82317 0.762615 9.82317 0.469722 9.53027C0.176829 9.23738 0.176829 8.76262 0.469722 8.46973L6.83593 2.10254C6.3319 2.16472 5.79596 2.21841 5.25 2.24902C3.8302 2.32862 2.2474 2.26906 0.958003 1.79102L0.704097 1.68945L0.635738 1.65527C0.303274 1.47099 0.157578 1.06102 0.310542 0.704102C0.463655 0.347333 0.860941 0.170391 1.22363 0.28418L1.29589 0.310547L1.48828 0.387695C2.47399 0.751207 3.79966 0.827571 5.16601 0.750977C6.60111 0.670504 7.97842 0.428235 8.86132 0.262695L9.95312 0.0585938L9.73535 1.14746Z">
                                                    </path>
                                                </svg></span><span>Book Now<svg width="10" height="10"
                                                    viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M9.73535 1.14746C9.57033 1.97255 9.32924 3.26406 9.24902 4.66797C9.16817 6.08312 9.25559 7.5453 9.70214 8.73633C9.84754 9.12406 9.65129 9.55659 9.26367 9.70215C8.9001 9.83849 8.4969 9.67455 8.32812 9.33398L8.29785 9.26367L8.19921 8.98438C7.73487 7.5758 7.67054 5.98959 7.75097 4.58203C7.77875 4.09598 7.82525 3.62422 7.87988 3.17969L1.53027 9.53027C1.23738 9.82317 0.762615 9.82317 0.469722 9.53027C0.176829 9.23738 0.176829 8.76262 0.469722 8.46973L6.83593 2.10254C6.3319 2.16472 5.79596 2.21841 5.25 2.24902C3.8302 2.32862 2.2474 2.26906 0.958003 1.79102L0.704097 1.68945L0.635738 1.65527C0.303274 1.47099 0.157578 1.06102 0.310542 0.704102C0.463655 0.347333 0.860941 0.170391 1.22363 0.28418L1.29589 0.310547L1.48828 0.387695C2.47399 0.751207 3.79966 0.827571 5.16601 0.750977C6.60111 0.670504 7.97842 0.428235 8.86132 0.262695L9.95312 0.0585938L9.73535 1.14746Z">
                                                    </path>
                                                </svg></span></a><a class="primary-btn1 two transparent"
                                            href="../../checkout/"><span><svg width="18" height="18" viewBox="0 0 18 18"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                ...
                                                </svg>Add to Cart</span><span><svg width="18" height="18"
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" id="flush-package-headingTwo">
                                <div class="accordion-button collapsed" role="button" data-bs-toggle="collapse"
                                    ...
                                    <div class="batch"><span>Family Tour</span></div>
                                    <div class="title-area"><span class="check"></span>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" id="flush-package-headingThree">
                                <div class="accordion-button collapsed" role="button" data-bs-toggle="collapse"
                                    ...
                                    <div class="batch"><span>Private Tour</span></div>
                                    <div class="title-area"><span class="check"></span>
                    ...
                    <div class="row g-4 mb-50">
                        ...
                        <div class="col-md-6">
                            <div class="form-inner"><label>Travel Date</label>
                                <div class="date-field-area"><input type="date" readonly="" name="inOut"
                                        value="Sep 12 - Sep 20"><svg class="calender-icon" width="14" height="14"
            ...
            <div class="col-xl-7 col-lg-8">
                <div class="package-details-warpper">
                    <div class="package-info-wrap mb-60">
                        ...
                        <p>
                            Hành trình 10N9Đ đưa bạn dạo bước giữa <b>Paris</b> hoa lệ với <b>tháp Eiffel</b> và dòng sông Seine lãng mạn,
                             băng qua thiên nhiên hùng vĩ của <b>Thụy Sĩ</b> với những ngôi làng cổ tích và dãy Alps phủ tuyết, 
                             trước khi đắm mình trong không gian nghệ thuật – lịch sử tại <b>Ý</b> qua <b>Milan</b> thời trang, <b>Venice</b> thơ mộng, 
                             <b>Pisa</b> nghiêng mình và <b>Rome</b> cổ kính – tất cả gói gọn trong một hành trình trọn vẹn những biểu tượng đẹp nhất châu Âu.</p>
                        <ul class="package-info-list">
                            ...
                            <li><svg width="30" height="30" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="content"><span>Ngôn ngữ</span><strong>Anh - Pháp - Ý</strong></div>
                            </li>
                            <li><svg width="30" height="30" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="location-card">
                                            <div class="location-img"><img alt="" loading="lazy" width="550"
                                                    height="220" decoding="async" data-nimg="1"
                                                    style="color:transparent" src="assets/images/tour-temp/eiffel.webp">
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="location-card">
                                            <div class="location-img"><img alt="" loading="lazy" width="550"
                                                    height="220" decoding="async" data-nimg="1"
                                                    style="color:transparent" src="assets/images/tour-temp/louvre.webp">
                                            </div>
                                            <div class="location-content">
                                                <h6>Bảo tàng Louvre</h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="location-card">
                                            <div class="location-img"><img alt="" loading="lazy" width="550"
                                                    height="220" decoding="async" data-nimg="1"
                                                    style="color:transparent" src="assets/images/tour-temp/khm.jpg">
                                            </div>
                                            <div class="location-content">
                                                <h6>Khải Hoàn Môn</h6>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="location-card">
                                            <div class="location-img"><img alt="" loading="lazy" width="550"
                                                    height="220" decoding="async" data-nimg="1"
                                                    style="color:transparent" src="assets/images/tour-temp/lang.jpg">
                                            </div>
                                            <div class="location-content">
                                                <h6>Làng Iseltwald</h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="location-card">
                                            <div class="location-img"><img alt="" loading="lazy" width="550"
                                                    height="220" decoding="async" data-nimg="1"
                                                    style="color:transparent" src="assets/images/tour-temp/Titlis-Paranoma.jpeg">
                                            </div>
                                            <div class="location-content">
                                                <h6>Núi Titlis</h6>
                                            </div>
                            ...
                            <li class="single-itinerary">
                                <div class="tour-plan-wrap">
                                    <div class="accordion accordion-flush" id="accordionTourPlan">
                                        <div class="accordion-item">
                                            <div class="accordion-header" id="flush-headingTourPlan-1">
                                                <div class="accordion-button" role="button" data-bs-toggle="collapse"
                                                    data-bs-target="#flush-collapseTourPlan-1" aria-expanded="false"
                                                    aria-controls="flush-collapseTourPlan-1">
                                                    <h6><span><svg width="14" height="14" viewBox="0 0 14 14"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                                            ...
                                                            </svg>Ngày 1:</span>TPHCM – PARIS
                                                    </h6>
                                                </div>
                                            </div>
                                            <div id="flush-collapseTourPlan-1" class="accordion-collapse collapse show"
                                                aria-labelledby="flush-headingTourPlan-1">
                                                <div class="accordion-body">
                                                    
                                                    Quý khách tập trung tại sân bay Tân Sơn Nhất, làm thủ tục đáp chuyến bay đi Paris (Quá cảnh tùy hãng hàng không).<br><br>
                                        ...
                                        <div class="accordion-item">
                                            <div class="accordion-header" id="flush-headingTourPlan-2">
                                                <div class="accordion-button collapsed" role="button"
                                                    data-bs-toggle="collapse" data-bs-target="#flush-collapseTourPlan-2"
                                                    aria-expanded="false" aria-controls="flush-collapseTourPlan-2">
                                                    <h6><span><svg width="14" height="14" viewBox="0 0 14 14"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                                                    d="M7 14C7 14 12.25 9.02475 12.25 5.25C12.25 3.85761 11.6969 2.52226 10.7123 1.53769C9.72774 0.553123 8.39239 0 7 0C5.60761 0 4.27226 0.553123 3.28769 1.53769C2.30312 2.52226 1.75 3.85761 1.75 5.25C1.75 9.02475 7 14 7 14ZM7 7.875C6.30381 7.875 5.63613 7.59844 5.14384 7.10616C4.65156 6.61387 4.375 5.94619 4.375 5.25C4.375 4.55381 4.65156 3.88613 5.14384 3.39384C5.63613 2.90156 6.30381 2.625 7 2.625C7.69619 2.625 8.36387 2.90156 8.85616 3.39384C9.34844 3.88613 9.625 4.55381 9.625 5.25C9.625 5.94619 9.34844 6.61387 8.85616 7.10616C8.36387 7.59844 7.69619 7.875 7 7.875Z">
                                                                </path>
                                                            </svg>Ngày 2:</span> PARIS (Ăn sáng, trưa, tối)
                                                    </h6>
                                                </div>
                                            </div>
                                            <div id="flush-collapseTourPlan-2" class="accordion-collapse collapse"
                                                aria-labelledby="flush-headingTourPlan-2">
                                                <div class="accordion-body">
                                                    <p style="text-align: justify;"><span style="font-size:16px;">Đoàn ăn sáng tại khách sạn.</span></p>
                                                    <p style="text-align: justify;"><span style="font-size:16px;">Sau đó đoàn bắt đầu khám phá Paris.</span></p>
                                                    <p style="text-align: justify;"><span style="font-size:16px;">Điểm đến đầu tiên là <strong>Đồi Montmartre</strong> - được mệnh danh là “khu phố nghệ sĩ”. Bởi nơi đây đã từng là chốn nghỉ chân của rất nhiều những nghệ sĩ nổi tiếng trên thế giới. Đặc biệt có thể kể tới như Van Gogh, Picasso hay Modigliani,… (Chụp hình bên ngoài).</span></p>
                                                    <p style="text-align: justify;"><span style="font-size:16px;">Tham quan <strong>Bảo tàng Louvre (chụp hình bên ngoài)</strong> - nơi trưng bày các báu vật hội họa, kiến trúc của nhân loại. Ăn trưa.</span></p>
                                                    <p style="text-align: justify;"><span style="font-size:16px;">Chiều, quý khách trải nghiệm <strong>Du thuyền trên dòng sông Seine</strong> khám phá vẻ đẹp hai bên bờ sông và những cây cầu cổ, tiêu biểu nhất là <strong>cầu Alexandre III.</strong>&nbsp;</span></p>
                                                    <p style="text-align: justify;"><span style="font-size:16px;">Tháp Eiffel - công trình kiến trúc bằng sắt sừng sững bên bờ sông Seine, biểu tượng và là niềm tự hào của nước Pháp (chụp hình bên ngoài)</span></p>
                                                    <p style="text-align: justify;"><span style="font-size:16px;">Đoàn ăn tối và về khách sạn, Qúy khách tự do chiêm ngưỡng Paris về đêm.</span></p>
                                                    <p style="text-align: justify;"><span style="font-size:16px;"><strong><em>Nghỉ đêm tại Paris.</em></strong></span></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="accordion-item">
                                            <div class="accordion-header" id="flush-headingTourPlan-3">
                                                <div class="accordion-button collapsed" role="button"
                                                    data-bs-toggle="collapse" data-bs-target="#flush-collapseTourPlan-3"
                                                    aria-expanded="false" aria-controls="flush-collapseTourPlan-3">
                                                    <h6><span><svg width="14" height="14" viewBox="0 0 14 14"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                                                    d="M7 14C7 14 12.25 9.02475 12.25 5.25C12.25 3.85761 11.6969 2.52226 10.7123 1.53769C9.72774 0.553123 8.39239 0 7 0C5.60761 0 4.27226 0.553123 3.28769 1.53769C2.30312 2.52226 1.75 3.85761 1.75 5.25C1.75 9.02475 7 14 7 14ZM7 7.875C6.30381 7.875 5.63613 7.59844 5.14384 7.10616C4.65156 6.61387 4.375 5.94619 4.375 5.25C4.375 4.55381 4.65156 3.88613 5.14384 3.39384C5.63613 2.90156 6.30381 2.625 7 2.625C7.69619 2.625 8.36387 2.90156 8.85616 3.39384C9.34844 3.88613 9.625 4.55381 9.625 5.25C9.625 5.94619 9.34844 6.61387 8.85616 7.10616C8.36387 7.59844 7.69619 7.875 7 7.875Z">
                                                                </path>
                                                            </svg>Ngày 3:</span>PARIS - COLMAR (Ăn sáng, trưa, tối)
                                                    </h6>
                                                </div>
                                            </div>
                                            <div id="flush-collapseTourPlan-3" class="accordion-collapse collapse"
                                                aria-labelledby="flush-headingTourPlan-3">
                                                <div class="accordion-body">The Eiffel Tower is the heart of Paris
                                                    and offers a variety of exciting activities for visitors. As
                                                    like, climb the Eiffel Tower, take the elevator to the summit,
                                                    sunset &amp; night view, picnic at champ de mars &amp; bike tour
                                            ...
                                            <div class="accordion-header" id="flush-headingTourPlan-3">
                                                <div class="accordion-button collapsed" role="button"
                                                    ...
                                                    <h6><span><svg width="14" height="14" viewBox="0 0 14 14"
                                                            ...
                                                            </svg>Ngày 4:</span>COLMAR – INTERLAKEN - ZURICH (THỤY SĨ) (Ăn sáng, trưa, tối)
                                                    </h6>
                                                </div>
                                            </div>
                                            <div id="flush-collapseTourPlan-3" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-header" id="flush-headingTourPlan-3">
                                                <div class="accordion-button collapsed" role="button"
                                                    ...
                                                    <h6><span><svg width="14" height="14" viewBox="0 0 14 14"
                                                            ...
                                                            </svg>Ngày 5:</span>ZURICH – ENGELBERG – MILAN (Ăn sáng, trưa, tối) 
                                                    </h6>
                                                </div>
                                            </div>
                                            <div id="flush-collapseTourPlan-3" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-header" id="flush-headingTourPlan-3">
                                                <div class="accordion-button collapsed" role="button"
                                                    ...
                                                    <h6><span><svg width="14" height="14" viewBox="0 0 14 14"
                                                            ...
                                                            </svg>Ngày 6:</span>MILAN – FLORENCE (Ăn sáng, trưa, tối)
                                                    </h6>
                                                </div>
                                            </div>
                                            <div id="flush-collapseTourPlan-3" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-header" id="flush-headingTourPlan-3">
                                                <div class="accordion-button collapsed" role="button"
                                                    ...
                                                    <h6><span><svg width="14" height="14" viewBox="0 0 14 14"
                                                            ...
                                                            </svg>Ngày 7:</span>FLORENCE – PISA - ROME (Ăn sáng, trưa, tối)
                                                    </h6>
                                                </div>
                                            </div>
                                            <div id="flush-collapseTourPlan-3" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-header" id="flush-headingTourPlan-3">
                                                <div class="accordion-button collapsed" role="button"
                                                    ...
                                                    <h6><span><svg width="14" height="14" viewBox="0 0 14 14"
                                                            ...
                                                            </svg>Ngày 8:</span>ROME (Ăn sáng, trưa, tối)
                                                    </h6>
                                                </div>
                                            </div>
                                            <div id="flush-collapseTourPlan-3" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-header" id="flush-headingTourPlan-3">
                                                <div class="accordion-button collapsed" role="button"
                                                    ...
                                                    <h6><span><svg width="14" height="14" viewBox="0 0 14 14"
                                                            ...
                                                            </svg>Ngày 9:</span>ROME – TPHCM (Ăn sáng)
                                                    </h6>
                                                </div>
                                            </div>
                                            <div id="flush-collapseTourPlan-3" class="accordion-collapse collapse"
                                ...
                                <div class="single-feature-list">
                                    ...
                                    <ul class="items-list two">
                                        ...
                                        <li><svg class="exclude" width="16" height="16" viewBox="0 0 16 16"
                                            ...
                                            </svg>Tiền bồi dưỡng cho hướng dẫn viên và tài xế: 8Eur/khách/ngày</li>
                                        <li><svg class="exclude" width="16" height="16" viewBox="0 0 16 16"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                    <path
                    ...
                    <div class="faq-area mb-60">
                        ...
                        <div class="faq-wrap">
                            <div class="accordion accordion-flush" id="accordionFlushExample">
                                <div class="accordion-item">
                                    <h5 class="accordion-header" id="flush-headingOne"><button class="accordion-button"
                                            type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne"
                                            aria-expanded="false" aria-controls="flush-collapseOne">What are the
                                            must-visit places in
                                            France?</button></h5>
                                    <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                        aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body">Top destinations include Paris (Eiffel Tower,
                                            Louvre), Nice (French Riviera), Bordeaux (wine tours), Provence
                                            (lavender fields), and Normandy (Mont Saint-Michel).</div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h5 class="accordion-header" id="flush-headingTwo"><button
                                            class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#flush-collapseTwo" aria-expanded="false"
                                            aria-controls="flush-collapseTwo">Do tour packages
                                            include entrance fees?</button></h5>
                                    <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                        aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body">Yes, most of our tour packages include entrance
                                            fees to major attractions as listed in the itinerary. However, optional
                                            activities or personal expenses may not be covered. Please check the
                                            inclusions section of your selected package for full details.</div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h5 class="accordion-header" id="flush-headingThree"><button
                                            class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#flush-collapseThree" aria-expanded="false"
                                            aria-controls="flush-collapseThree">What type of
                                            accommodation is included?</button></h5>
                                    <div id="flush-collapseThree" class="accordion-collapse collapse"
                                        aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body">Our packages typically include stays in 3 to
                                            4-star hotels, offering comfortable rooms with essential amenities.
                                            Higher or boutique categories may be available upon request or in
                                            premium packages. Accommodation details are provided in each tour
                                            itinerary.</div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h5 class="accordion-header" id="flush-headingFour"><button
                                            class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#flush-collapseFour" aria-expanded="false"
                                            aria-controls="flush-collapseFour">Will I get a
                                            full refund if I cancel my trip?</button></h5>
                                    <div id="flush-collapseFour" class="accordion-collapse collapse"
                                        aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body">Refund eligibility depends on the cancellation
                                            policy of the specific tour package. While some packages offer a full
                                            refund if canceled within a certain time frame, others may involve
                                            partial charges. Please refer to the cancellation terms provided during
                                            booking for full details.</div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h5 class="accordion-header" id="flush-headingFive"><button
                                            class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#flush-collapseFive" aria-expanded="false"
                                            aria-controls="flush-collapseFive">What travel
                                            documents should I carry?</button></h5>
                                    <div id="flush-collapseFive" class="accordion-collapse collapse"
                                        aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body">You should carry a valid passport, visa (if
                                            required), travel insurance, flight tickets, hotel booking
                                            confirmations, and a government-issued ID. It’s also helpful to have
                                            copies of important documents and emergency contact information.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="package-details-sidebar">
                    <div class="pricing-and-booking-area mb-40">
                        <div class="price-area">
                            <h6>Giá tour</h6><span> 103,900,000 đ<sub>/người</sub></span> <del>125,900,000 đ</del><sub>/người</sub>
                        </div>
                        <ul>
                    ...
                    <div class="customize-package-banner-wrap">
                        ...
                        <div class="counter-area">
                            <ul class="counter-img-grp">
                                <li><img alt="" loading="lazy" width="550" height="220" decoding="async" data-nimg="1"
                                        style="color:transparent"
                                        src="https://ui-avatars.com/api/?name=Tuấn">
                                </li>
                                <li><img alt="" loading="lazy" width="550" height="220" decoding="async" data-nimg="1"
                                        style="color:transparent"
                                        src="https://ui-avatars.com/api/?name=Nguyen">
                                </li>
                                <li><img alt="" loading="lazy" width="550" height="220" decoding="async" data-nimg="1"
                                        style="color:transparent"
                                        src="https://ui-avatars.com/api/?name=Anh">
                                </li>
                            </ul>
                            <h6 style="font-size:12px"> <strong>Đội ngũ hướng dẫn viên luôn đồng hành cùng bạn</h6>
                        </div><a class="primary-btn1 two black-bg" href="../../contact/"><span>Thiết kế hành trình<svg
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="package-card">
                                <div class="package-img-wrap"><a class="package-img"
                                        href="../../experience-details/"><img alt="" loading="lazy" width="395"
                                            height="240" decoding="async" data-nimg="1" style="color:transparent"
                                            srcset="../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img1.jpg%26w%3D640%26q%3D75 1x, ../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img1.jpg%26w%3D828%26q%3D75 2x"
                                            src="../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img1.jpg%26w%3D828%26q%3D75"></a>
                                    <div class="batch"><span>Sale on!</span></div>
                                </div>
                                <div class="package-content">
                                    <h5><a href="../../experience-details/">Zip-lining &amp; Canopy</a></h5>
                                    <div class="location-and-time">
                                        <div class="location"><svg width="14" height="14" viewBox="0 0 14 14"
                                            ...
                                            </svg><a href="../../experience-grid/">Himachal Pradesh, India</a></div>
                                        ...
                                        </svg><span>01 Hour</span>
                                    </div>
                                    <div class="btn-and-price-area"><a class="primary-btn1"
                                            href="../../experience-details/"><span>Book Now<svg width="10" height="10"
                                                    viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M9.73535 1.14746C9.57033 1.97255 9.32924 3.26406 9.24902 4.66797C9.16817 6.08312 9.25559 7.5453 9.70214 8.73633C9.84754 9.12406 9.65129 9.55659 9.26367 9.70215C8.9001 9.83849 8.4969 9.67455 8.32812 9.33398L8.29785 9.26367L8.19921 8.98438C7.73487 7.5758 7.67054 5.98959 7.75097 4.58203C7.77875 4.09598 7.82525 3.62422 7.87988 3.17969L1.53027 9.53027C1.23738 9.82317 0.762615 9.82317 0.469722 9.53027C0.176829 9.23738 0.176829 8.76262 0.469722 8.46973L6.83593 2.10254C6.3319 2.16472 5.79596 2.21841 5.25 2.24902C3.8302 2.32862 2.2474 2.26906 0.958003 1.79102L0.704097 1.68945L0.635738 1.65527C0.303274 1.47099 0.157578 1.06102 0.310542 0.704102C0.463655 0.347333 0.860941 0.170391 1.22363 0.28418L1.29589 0.310547L1.48828 0.387695C2.47399 0.751207 3.79966 0.827571 5.16601 0.750977C6.60111 0.670504 7.97842 0.428235 8.86132 0.262695L9.95312 0.0585938L9.73535 1.14746Z">
                                                    </path>
                                    ...
                                    <div class="bottom-area">
                                        <ul>
                                            <li><svg width="16" height="16" viewBox="0 0 16 16"
                                                    ...
                                                    <div class="tooltip-text">Including Activities <span>Scuba
                                                            Diving, Zip-lining, Rafting &amp; Rock Climbing</span>
                                                        with this premium package.</div>
                                                </div>
                                            </li>
                                            <li><svg width="16" height="16" viewBox="0 0 16 16"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                </svg>Inclusion<div class="info"><svg width="12" height="12"
                                                        viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                                                            <path
                                                                d="M6 0.375C4.88748 0.375 3.79995 0.704901 2.87492 1.32298C1.94989 1.94107 1.22892 2.81957 0.80318 3.84741C0.377437 4.87524 0.266043 6.00624 0.483085 7.09738C0.700127 8.18853 1.23586 9.19081 2.02253 9.97748C2.8092 10.7641 3.81148 11.2999 4.90262 11.5169C5.99376 11.734 7.12476 11.6226 8.1526 11.1968C9.18043 10.7711 10.0589 10.0501 10.677 9.12508C11.2951 8.20006 11.625 7.11252 11.625 6C11.6245 4.50831 11.0317 3.07786 9.97693 2.02307C8.92215 0.968289 7.49169 0.375497 6 0.375ZM6 9.375C5.85167 9.375 5.70666 9.33101 5.58333 9.2486C5.45999 9.16619 5.36386 9.04906 5.30709 8.91201C5.25033 8.77497 5.23548 8.62417 5.26441 8.47868C5.29335 8.3332 5.36478 8.19956 5.46967 8.09467C5.57456 7.98978 5.7082 7.91835 5.85369 7.88941C5.99917 7.86047 6.14997 7.87533 6.28702 7.93209C6.42406 7.98886 6.54119 8.08499 6.62361 8.20832C6.70602 8.33166 6.75 8.47666 6.75 8.625C6.74941 8.82373 6.6702 9.01415 6.52968 9.15468C6.38915 9.2952 6.19873 9.37441 6 9.375ZM6.85875 3.55875L6.6075 6.56625C6.5944 6.71834 6.52472 6.85999 6.41224 6.9632C6.29976 7.0664 6.15266 7.12367 6 7.12367C5.84735 7.12367 5.70024 7.0664 5.58776 6.9632C5.47528 6.85999 5.40561 6.71834 5.3925 6.56625L5.14125 3.55875C5.13042 3.44226 5.1434 3.32478 5.1794 3.21346C5.2154 3.10214 5.27367 2.99931 5.35067 2.91123C5.42767 2.82314 5.52178 2.75165 5.62729 2.70108C5.73279 2.65052 5.84748 2.62195 5.96437 2.61711C6.08127 2.61227 6.19793 2.63126 6.30725 2.67294C6.41657 2.71461 6.51627 2.77808 6.60029 2.8595C6.6843 2.94092 6.75087 3.03858 6.79595 3.14655C6.84103 3.25451 6.86367 3.37051 6.8625 3.4875C6.86313 3.51131 6.86187 3.53514 6.85875 3.55875Z">
                                                    ...
                                                    <div class="tooltip-text">This package covers
                                                        <span>Accommodation, Daily Meals, Entry Fees &amp; Local
                                                            Transfers</span> to ensure a worry-free trip.
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
                        ...
                        <div class="swiper-slide">
                            <div class="package-card">
                                <div class="package-img-wrap">
                                    <div class="swiper package-card-img-slider">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide"><a class="package-img"
                                                    href="../../experience-details/"><img alt="" loading="lazy"
                                                        width="395" height="240" decoding="async" data-nimg="1"
                                                        style="color:transparent"
                                                        srcset="../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img2.jpg%26w%3D640%26q%3D75 1x, ../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img2.jpg%26w%3D828%26q%3D75 2x"
                                                        src="../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img2.jpg%26w%3D828%26q%3D75"></a>
                                            </div>
                                            <div class="swiper-slide"><a class="package-img"
                                                    href="../../experience-details/"><img alt="" loading="lazy"
                                                        width="395" height="240" decoding="async" data-nimg="1"
                                                        style="color:transparent"
                                                        srcset="../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img3.jpg%26w%3D640%26q%3D75 1x, ../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img3.jpg%26w%3D828%26q%3D75 2x"
                                                        src="../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img3.jpg%26w%3D828%26q%3D75"></a>
                                            </div>
                                            <div class="swiper-slide"><a class="package-img"
                                                    href="../../experience-details/"><img alt="" loading="lazy"
                                                        width="395" height="240" decoding="async" data-nimg="1"
                                                        style="color:transparent"
                                                        srcset="../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img4.jpg%26w%3D640%26q%3D75 1x, ../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img4.jpg%26w%3D828%26q%3D75 2x"
                                                        src="../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img4.jpg%26w%3D828%26q%3D75"></a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="batch"><span>Sale on!</span><span class="yellow-bg">Group
                                            Tour</span></div>
                                </div>
                                <div class="package-content">
                                    <h5><a href="../../experience-details/">Snowboarding &amp; Ice Thrills</a></h5>
                                    <div class="location-and-time">
                                        <div class="location"><svg width="14" height="14" viewBox="0 0 14 14"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                            ...
                                            </svg><a href="../../experience-grid/">Maldives</a></div><svg class="arrow"
                                            width="25" height="6" viewBox="0 0 25 6" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M0 3L5 5.88675V0.113249L0 3ZM25 3L20 0.113249V5.88675L25 3ZM4.5 3.5H20.5V2.5H4.5V3.5Z">
                                            </path>
                                        </svg><span>30 Minute</span>
                                    </div>
                                    <div class="btn-and-price-area"><a class="primary-btn1"
                                            href="../../experience-details/"><span>Book Now<svg width="10" height="10"
                                                    viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="price-area">
                                            <h6>Starting From</h6><span>$49</span>
                                        </div>
                                    </div><svg class="divider" height="6" viewBox="0 0 374 6"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                        ...
                        <div class="swiper-slide">
                            <div class="package-card">
                                <div class="package-img-wrap"><a class="package-img"
                                        href="../../experience-details/"><img alt="" loading="lazy" width="395"
                                            height="240" decoding="async" data-nimg="1" style="color:transparent"
                                            srcset="../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img5.jpg%26w%3D640%26q%3D75 1x, ../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img5.jpg%26w%3D828%26q%3D75 2x"
                                            src="../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img5.jpg%26w%3D828%26q%3D75"></a>
                                    <div class="batch"><span class="yellow-bg">Family Tour</span></div>
                                </div>
                                <div class="package-content">
                                    <h5><a href="../../experience-details/">Skydiving &amp; Paragliding</a></h5>
                                    <div class="location-and-time">
                                        <div class="location"><svg width="14" height="14" viewBox="0 0 14 14"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                            ...
                                            </svg><a href="../../experience-grid/">Nepal</a></div><svg class="arrow"
                                            width="25" height="6" viewBox="0 0 25 6" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M0 3L5 5.88675V0.113249L0 3ZM25 3L20 0.113249V5.88675L25 3ZM4.5 3.5H20.5V2.5H4.5V3.5Z">
                                            </path>
                                        </svg><span>40 Minute</span>
                                    </div>
                                    <div class="btn-and-price-area"><a class="primary-btn1"
                                            href="../../experience-details/"><span>Book Now<svg width="10" height="10"
                                                    viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="price-area">
                                            <h6>Per Person</h6><span>$129</span>
                                        </div>
                                    </div><svg class="divider" height="6" viewBox="0 0 374 6"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                        ...
                        <div class="swiper-slide">
                            <div class="package-card">
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide"><a class="package-img"
                                                    href="../../experience-details/"><img alt="" loading="lazy"
                                                        width="395" height="240" decoding="async" data-nimg="1"
                                                        style="color:transparent"
                                                        srcset="../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img6.jpg%26w%3D640%26q%3D75 1x, ../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img6.jpg%26w%3D828%26q%3D75 2x"
                                                        src="../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img6.jpg%26w%3D828%26q%3D75"></a>
                                            </div>
                                            <div class="swiper-slide"><a class="package-img"
                                                    href="../../experience-details/"><img alt="" loading="lazy"
                                                        width="395" height="240" decoding="async" data-nimg="1"
                                                        style="color:transparent"
                                                        srcset="../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img7.jpg%26w%3D640%26q%3D75 1x, ../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img7.jpg%26w%3D828%26q%3D75 2x"
                                                        src="../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img7.jpg%26w%3D828%26q%3D75"></a>
                                            </div>
                                            <div class="swiper-slide"><a class="package-img"
                                                    href="../../experience-details/"><img alt="" loading="lazy"
                                                        width="395" height="240" decoding="async" data-nimg="1"
                                                        style="color:transparent"
                                                        srcset="../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img8.jpg%26w%3D640%26q%3D75 1x, ../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img8.jpg%26w%3D828%26q%3D75 2x"
                                                        src="../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img8.jpg%26w%3D828%26q%3D75"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="slider-pagi-wrap">
                                ...
                                <div class="package-content">
                                    <h5><a href="../../experience-details/">Surfing &amp; Waterfalls</a></h5>
                                    <div class="location-and-time">
                                        <div class="location"><svg width="14" height="14" viewBox="0 0 14 14"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                            ...
                                            </svg><a href="../../experience-grid/">Goa, India</a></div><svg
                                            class="arrow" width="25" height="6" viewBox="0 0 25 6"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M0 3L5 5.88675V0.113249L0 3ZM25 3L20 0.113249V5.88675L25 3ZM4.5 3.5H20.5V2.5H4.5V3.5Z">
                                            </path>
                                        </svg><span>20 Minute</span>
                                    </div>
                                    <div class="btn-and-price-area"><a class="primary-btn1"
                                            href="../../experience-details/"><span>Book Now<svg width="10" height="10"
                                                    viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="price-area">
                                            <h6>Stating From</h6><span>$39</span>
                                        </div>
                                    </div><svg class="divider" height="6" viewBox="0 0 374 6"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                        ...
                        <div class="swiper-slide">
                            <div class="package-card">
                                <div class="package-img-wrap"><a class="package-img"
                                        href="../../experience-details/"><img alt="" loading="lazy" width="395"
                                            height="240" decoding="async" data-nimg="1" style="color:transparent"
                                            srcset="../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img9.jpg%26w%3D640%26q%3D75 1x, ../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img9.jpg%26w%3D828%26q%3D75 2x"
                                            src="../../_next/image/url%3D%252Fassets%252Fimg%252Fhome6%252Ftour-package-img9.jpg%26w%3D828%26q%3D75"></a>
                                    <div class="batch"><span class="yellow-bg">Group Tour</span></div>
                                </div>
                                <div class="package-content">
                                    <h5><a href="../../experience-details/">Mountain Rock Climbing</a></h5>
                                    <div class="location-and-time">
                                        <div class="location"><svg width="14" height="14" viewBox="0 0 14 14"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                            ...
                                            </svg><a href="../../experience-grid/">Switzerland,</a><a
                                                href="../../experience-grid/">Nepal</a></div><svg class="arrow"
                                            width="25" height="6" viewBox="0 0 25 6" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M0 3L5 5.88675V0.113249L0 3ZM25 3L20 0.113249V5.88675L25 3ZM4.5 3.5H20.5V2.5H4.5V3.5Z">
                                            </path>
                                        </svg><span>45 Minute</span>
                                    </div>
                                    <div class="btn-and-price-area"><a class="primary-btn1"
                                            href="../../experience-details/"><span>Book Now<svg width="10" height="10"
                                                    viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="price-area">
                                            <h6>Starting From</h6><span>$89</span>
                                        </div>
                                    </div><svg class="divider" height="6" viewBox="0 0 374 6"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
